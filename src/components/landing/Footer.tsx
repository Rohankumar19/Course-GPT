...
const Footer = () => {
  return (
    <footer className="bg-coursegpt-blue text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/generator" className="text-gray-300 hover:text-white">Course Generator</Link></li>
              <li><Link to="#" className="text-gray-300 hover:text-white">Module Organizer</Link></li>
              <li><Link to="#" className="text-gray-300 hover:text-white">Content Editor</Link></li>
